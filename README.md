...
Yatrii is an all-in-one travel booking platform for rides, car rentals, outstation journeys, and hotels. It provides a modern yellow-and-white interface for comparing fares, searching stays, managing bookings, and accessing travel safety tools.
...
- View hotel details, rooms, photos, facilities, and pricing.
- Book self-drive rentals and outstation vehicles.
- Apply travel coupons during checkout.
...
- JavaScript for frontend interactions and application logic
- React for the theme toggle component
- Node.js and Express for the REST API backend
- JSON files for local application data
